...
PIZZA_ENKA_API_DOCS = "https://raw.githubusercontent.com/pizza-studio/EnkaDBGenerator/main/Sources/EnkaDBFiles/Resources/Specimen/GI"
...
PATH_TO_SOURCE = {
    ...
    PFPS_DATA_PATH: f"{PIZZA_ENKA_API_DOCS}/pfps.json",
    NAMECARD_DATA_PATH: f"{PIZZA_ENKA_API_DOCS}/namecards.json",
}
